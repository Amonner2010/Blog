<?php 
    ...
    function get_pagination_vars() {
        ...
        // Add page number to query string if not there already
        if(!strstr($query_string, "page=")) {
            $query_string .= "&page=" . $page_number;
        }

        // Trim query and set current link
    ...
    // --- Collect Summernote Images --- //
    function remove_images_from_content($content, $folder = 'uploads/') {
        // Find all images within Summernote
    ...
    // --- Add Root to Display Summernote Images --- //
    ...
    // --- Remove Root from Content --- //
    function remove_root_from_content($content, $folder = 'uploads/') {
